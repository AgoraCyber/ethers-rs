...
use ethers_fixed_hash::construct_fixed_hash;
...
fn eq_equal(c: &mut Criterion) {
    ...
    for input in [
        ...
        H256::from([
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xEF, 0x2D,
            0x6D, 0x19, 0x40, 0x84, 0xC2, 0xDE, 0x36, 0xE0, 0xDA, 0xBF, 0xCE, 0x45, 0xD0, 0x46,
            0xB3, 0x7D, 0x11, 0x06,
        ]),
...
fn eq_nonequal(c: &mut Criterion) {
    ...
    for input in [
        ...
        (
            ...
            H256::from([
                0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xEF, 0x2D,
                0x6D, 0x19, 0x40, 0x84, 0xC2, 0xDE, 0x36, 0xE0, 0xDA, 0xBF, 0xCE, 0x45, 0xD0, 0x46,
                0xB3, 0x7D, 0x11, 0x06,
            ]),
        ),
...
fn compare(c: &mut Criterion) {
    ...
    for input in [
        ...
        (
            H256::from([
                0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xEF, 0x2D,
                0x6D, 0x19, 0x40, 0x84, 0xC2, 0xDF, 0x36, 0xE0, 0xDA, 0xBF, 0xCE, 0x45, 0xD0, 0x46,
                0xB3, 0x7D, 0x11, 0x06,
            ]),
            H256::from([
                0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xEF, 0x2D,
